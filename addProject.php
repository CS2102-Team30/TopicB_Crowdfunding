        ...
        <div class="container">
            ...
            <form action="phpFunctions/processAdd.php" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        <input name="keyword[]" class="form-check-input" type="checkbox" value="Arts"/>
                        <label class="form-check-label">Arts</label>
                        <br>
                        <input name="keyword[]" class="form-check-input" type="checkbox" value="Tech"/>
                        <label class="form-check-label">Tech</label>
                        <br>
                        <input name="keyword[]" class="form-check-input" type="checkbox" value="Illustration"/>
                        <label class="form-check-label">Illustration</label>
                        <br>
                        <input name="keyword[]" class="form-check-input" type="checkbox" value="Games"/>
                        <label class="form-check-label">Games</label>
                        <br>
                        <input name="keyword[]" class="form-check-input" type="checkbox" value="Food"/>
                        <label class="form-check-label">Food</label>
                        <br>
                        <input name="keyword[]" class="form-check-input" type="checkbox" value="Music"/>
                        <label class="form-check-label">Music</label>
                        <br>
                        <input name="keyword[]" class="form-check-input" type="checkbox" value="Publishing"/>
                        <label class="form-check-label">Publishing</label>
                        <br>
                        <input name="keyword[]" class="form-check-input" type="checkbox" value="Film"/>
